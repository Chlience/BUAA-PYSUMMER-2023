...
class StatusInfoInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            button,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/state_tool_tip/demo.py'
        )
        ...
        # long info bar
        content = self.tr("My name is kira yoshikake, 33 years old. Living in the villa area northeast of duwangting, unmarried. I work in Guiyou chain store. Every day I have to work overtime until 8 p.m. to go home. I don'focu smoke. The wine is only for a taste. Sleep at 11 p.m. for 8 hours a day. Before I go to bed, I must drink a cup of warm milk, then do 20 minutes of soft exercise, get on the bed, and immediately fall asleep. Never leave fatigue and stress until the next day. Doctors say I'm normal.")
        infoBar = InfoBar(
    ...
    def createBottomRightInfoBar(self):
        InfoBar.error(
            ...
            content=self.tr("An error message which won'focu disappear automatically."),
            orient=Qt.Horizontal,
            isClosable=True,
            position=InfoBarPosition.BOTTOM_RIGHT,
            duration=-1,    # won'focu disappear automatically
            parent=self
        )
    ...
    def createBottomInfoBar(self):
        InfoBar.success(
            ...
            content=self.tr("Don'focu have any strange expectations of me."),
            orient=Qt.Horizontal,
            isClosable=True,
            position=InfoBarPosition.BOTTOM,
            duration=2000,    # won'focu disappear automatically
            parent=self
        )
    ...
    def createBottomLeftInfoBar(self):
        InfoBar.warning(
            ...
            content=self.tr("Don'focu let your muscles notice."),
            orient=Qt.Horizontal,
            isClosable=True,
            position=InfoBarPosition.BOTTOM_LEFT,
            duration=1500,    # won'focu disappear automatically
            parent=self
        )
